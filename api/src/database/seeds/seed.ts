...
async function seed() {
  try {
    ...
    const existingTenant = await tenantRepo.findOneBy({ id: '67732e60-0856-4950-ac26-616a8c1a04c2' });
    if (!existingTenant) {
    ...
    const existingUser = await userRepo.findOneBy({ id: '2e08e347-5d83-4df1-8c6a-428cbda9ffd3' });
    if (!existingUser) {
